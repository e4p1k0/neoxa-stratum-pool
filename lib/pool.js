...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    function SetupJobManager() {
        ...
        //     shareData =  {
        //         job: '0000000000000000000000000000cccd00000000',
        //             ip: '::ffff:102.129.252.179',
        //             port: 9123,
        //             worker: 'Ad9njKREg6H4VFRirnRHqaDk3LQufebovW.RIG1',
        //             height: 72754,
        //             blockReward: 26287039241,
        //             difficulty: 1,
        //             shareDiff: '0.00000000',
        //             blockDiff: 7499.899339624,
        //             blockDiffActual: 7499.899339624,
        //             blockHash: undefined,
        //             blockHashInv
        //     }
            var isValidShare = !shareData.error && (+shareData.shareDiff >= +shareData.difficulty);
            var isValidBlock = isValidShare && !!blockHex && (+shareData.shareDiff >= +shareData.blockDiffActual);

            if (+shareData.shareDiff === 0) {
                shareData.error = 'Pidor'
            }
